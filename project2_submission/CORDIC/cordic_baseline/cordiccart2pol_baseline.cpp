...
//    *theta = atan2(y, x);
        ...
        for (int j = 0; j < 12; j++) {
        	 ...
        	 */
        	data_t sigma = (current_sin > 0) ? -1 : 1;
//            printf("number of iter is %d \n", j);
//            printf("\tcurrent_cos is %f \n", current_cos);
//            printf("\tcurrent_sin is %f \n", current_sin);
//            printf("\tcurrent_theta is %f \n", current_theta);

//        	data_t cos_shift = current_cos * sigma >> j;
//        	data_t sin_shift = current_sin * sigma >> j;
        	data_t cos_shift = current_cos * sigma * Kvalues[j];
        	data_t sin_shift = current_sin * sigma * Kvalues[j];
//
